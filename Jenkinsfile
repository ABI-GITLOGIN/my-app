node{
   ...
   sh "docker login -u admin -p admin123 35.154.76.30:8083"
   sh "docker tag abiramipalani/myweb:0.0.2 35.154.76.30:8083/abi:1.0.0"
   sh 'docker push 35.154.76.30:8083/abi:1.0.0'
   }
